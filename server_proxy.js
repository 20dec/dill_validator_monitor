...
const entries = [
{pubkey: '0x920fc3f6f568cdf4bfc41c70d421f073d4e993016bbbb52386fba37be516ac01c491f9564a9032f31b3284bbc61d8b2c', port: 10001},
{pubkey: '0x8e496e01a42cb536580e51543fc13623f81add34f7479214e8659595ddc023c784060503ad683689a6ef40e4588dbd60', port: 10002},

];

const fetchValidatorData = async (pubkey, port) => {
    const proxyUrl = `http://username:password@host_or_ip:${port}`;
